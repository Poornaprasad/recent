...
export function mapInvoiceToDbRow(invoice: Partial<StoredInvoice>): Partial<Invoice> {
  ...
  return {
    ...
    saCreatedDate: invoice.saCreatedDate ? Math.floor(invoice.saCreatedDate.getTime() / 1000) as any : undefined,
    saModifiedUserId: invoice.saModifiedUserId,
    saModifiedDate: invoice.saModifiedDate ? Math.floor(invoice.saModifiedDate.getTime() / 1000) as any : undefined,
    ...
    saDocumentDate: invoice.saDocumentDate ? Math.floor(invoice.saDocumentDate.getTime() / 1000) as any : undefined,
