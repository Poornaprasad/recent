...
export default function InvoiceDetailPage() {
  ...
  const handleCheckDuplicates = async () => {
    ...
    if (!invoiceData) {
      toast({
        variant: 'destructive',
        title: 'Invoice Data Required',
        description: 'Invoice data is not available.',
      });
      return;
    }

    // Get vendor name, invoice number, and date from invoice
    const vendorName = typeof invoiceData.vendorName === 'object' && invoiceData.vendorName !== null
      ? invoiceData.vendorName.value
      : invoiceData.vendorName || '';
    
    const invoiceNumber = typeof invoiceData.invoiceNumber === 'object' && invoiceData.invoiceNumber !== null
      ? invoiceData.invoiceNumber.value
      : invoiceData.invoiceNumber || '';
    
    const invoiceDate = typeof invoiceData.invoiceDate === 'object' && invoiceData.invoiceDate !== null
      ? invoiceData.invoiceDate.value
      : invoiceData.invoiceDate || '';

    const amount = typeof invoiceData.amount === 'object' && invoiceData.amount !== null
