...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:block bg-sidebar-background text-sidebar-foreground"
        data-state={state}
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    className={cn(
      "mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l border-sidebar-border/50 pl-3.5",
      "group-data-[collapsible=icon]:hidden",
